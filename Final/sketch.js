...
function locationUno(){
  ...
  // line(eyelX, eyelY-7, video.width, eyelY-7)
  //going with the motion
  line(video.width-eyelX2+10, eyelY2-7, video.width, eyelY2-7)
  // line(eyelX, eyelY, 0, eyelY)
  fill(255, 0, 0);
  //going with th motion
  ellipse(video.width-eyelX2+10, eyelY2-7, d);
  //going against the motion
  // ellipse(eyelX, eyelY-7, d);
  pop();
